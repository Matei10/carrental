...
<?php } ?>
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td><?php echo htmlentities($result->VehiclesTitle ?? '') . ', ' . htmlentities($result->BrandName ?? '');?></td>
                                                    <td><?php echo htmlentities($result->FromDate ?? '');?></td>
                                                    <td><?php echo htmlentities($result->ToDate ?? '');?></td>
                                                    <td><?php echo htmlentities($tds = $result->totaldays ?? 0);?></td>
                                                    <td><?php echo htmlentities($ppd = $result->PricePerDay ?? 0);?></td>
                                                </tr>
                                                <tr>
                            ...
                            <?php if ($result->Status == 1) { ?>
                                <a href="user_info.php?amount=<?php echo htmlentities($tds * $ppd); ?>" class="btn btn-primary">Pay Now</a>

        ...
        <div class="col-md-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id); ?>" class="btn bg-green-500 hover:bg-green-700">View Details</a>
            </div>
          </div>
        </div>
      <?php }} ?>
...
<!-- Fun Facts -->
<section class="fun-facts-section bg-black !text-white">
  <div class="container text-center">
    <div class="row">
      <div class="col-md-3">
        <h2 class="!text-white">40+</h2>
        <p class="!text-green-300">Years In Business</p>
      </div>
      <div class="col-md-3">
        <h2 class="!text-white">1200+</h2>
          <p class="!text-green-300">New Cars For Sale</p>
      </div>
      <div class="col-md-3">
        <h2 class="!text-white">1000+</h2>
          <p class="!text-green-300">Used Cars For Sale</p>
      </div>
      <div class="col-md-3">
        <h2 class="!text-white">600+</h2>
          <p class="!text-green-300">Satisfied Customers</p>
      </div>
    </div>
  </div>
</section>
